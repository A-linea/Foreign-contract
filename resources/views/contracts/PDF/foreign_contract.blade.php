    ...
    <div class="container">
        ...
        <table style="border: 1px solid black">
            ...
            <tr>
                                ...
                                <td rowspan="2" style="border: 1px solid black;">Kiev</td>
                                <td rowspan="2" style="border: 1px solid black;">Persons</td>
                                <td rowspan="2" style="border: 1px solid black;">1</td>
                                <td colspan="2" style="border: 1px solid black;">Amount insured per person</td>
                                <td style="border: 1px solid black;">Insurance premium per person</td>
            </tr>
            <tr>
        ...
        <p style="margin-top: 5px">ТОВАРИСТВО З ДОДАТКОВОЮ ВІДПОВІДАЛЬНІСТЮ «СТРАХОВА КОМПАНІЯ «БЕНЄФІТ»  Адреса:
            ...
            030262,
            м. Київ,
            Столичне шосе 101 В,   тел. 0 800 33-05-54 Insurer: ADDITIONAL LIABILITY COMPANY «INSURANCE COMPANY «BENEFIT» Координати Контакт центра: +38 044 594 27 94 (мова спілкування українська, російська, англійська)</p>
        <hr>
        @include('contracts.PDF.parts.header')
